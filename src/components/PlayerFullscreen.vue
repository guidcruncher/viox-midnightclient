...
<template>
  <transition name="slide-up">
    <div
      v-if="showFullPlayer"
      class="fixed inset-0 z-50 flex flex-col bg-black/90 backdrop-blur-[50px] overflow-y-auto landscape:overflow-hidden"
    >
      <div class="flex items-center justify-between p-6 md:p-10 landscape:p-4">
        <button
        ...
        <div class="flex flex-col w-full max-w-lg landscape:justify-center">
          <div class="mt-10 landscape:mt-0 w-full text-center md:text-left">
            <div class="flex items-start justify-between">
              ...
              <button
                class="hidden rounded-full border border-white/10 p-3 text-white/50 hover:bg-white/10 hover:text-green-500 md:block landscape:hidden"
              >
